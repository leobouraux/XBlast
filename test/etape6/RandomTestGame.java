    ...
    public void testPositionsRandomGame() throws InterruptedException, IOException, URISyntaxException {
        ...
        while (!s.isGameOver()) {
           ...
           // Thread.sleep(15);
            ...
            Map<PlayerID, Optional<Direction>> a = randEvents.randomSpeedChangeEvents();
            s = s.next(a, randEvents.randomBombDropEvents());
            ...
            for(Player p: s.players()) {
                ...
                for(List<Integer> e: pos) {
                	...
                	/*if(p.id().equals(PlayerID.PLAYER_2)){
                	    ...
                	    System.out.println("Player "+h.position()+" "+h.direction().ordinal());
                	    
                	    System.out.println(a.keySet() + " "+ a.values());
